        ...
        int bx1 = 400, by1 = 1200, bx2 = 600, by2 = 900, bx3 = 800, by3 = 1400, bx4 = 1200, by4 = 1100, mx = 0, my = 100, px = 0, py = 100, cx = 0, cy = 0;
        ...
        void play() {
          ...
          draw_sprite(buffer, bal1, bx1, by1);
          draw_sprite(buffer, bal2, bx2, by2);
          draw_sprite(buffer, bal3, bx3, by3);
          draw_sprite(buffer, bal4, bx4, by4);
        ...
        void checkballoon() {
          if (by1 < -100) {
            bx1 = rand() % (1100 - 700) + 300;
            by1 = rand() % (1600 - 1000) + 1000;
            pass = 0;
            bal1dec = 0;
          }
          if (by2 < -100) {
            bx2 = rand() % (1300 - 700) + 300;
            by2 = rand() % (1200 - 1000) + 1000;
            pass = 0;
            bal2dec = 0;
          }
          if (by3 < -100) {
            bx3 = rand() % (1300 - 700) + 600;
            by3 = rand() % (1800 - 1000) + 1000;
            pass = 0;
            bal3dec = 0;
          }
          if (by4 < -100) {
            bx4 = rand() % (1300 - 700) + 400;
            by4 = rand() % (1600 - 1400) + 1400;
            pass = 0;
            bal4dec = 0;
          }
          if (by1 <= -10 && by1 >= -30 && bal1dec == 0) {
            life -= 1;
            bal1dec = 1;
          }
          if (by2 <= -10 && by2 >= -30 && bal2dec == 0) {
            life -= 1;
            bal2dec = 1;
          }
          if (by3 <= -10 && by3 >= -30 && bal3dec == 0) {
            life -= 1;
            bal3dec = 1;
          }
          if (by4 <= -10 && by4 >= -30 && bal4dec == 0) {
            life -= 1;
            bal4dec = 1;
          }
          if (mx + 40 >= bx1 && my >= by1 - 40 && my <= by1 + 40) {

            draw_sprite(screen, fire, bx1, by1);
          ...
          if (mx + 40 >= bx2 && my >= by2 - 40 && my <= by2 + 40) {

            draw_sprite(screen, fire, bx2, by2);
            by2 = -300;
            score += 75;
            int sound = play_sample(music, 300, 128, 1000, 0);
            pass = 1;
          }
          if (mx + 40 >= bx3 && my >= by3 - 40 && my <= by3 + 40) {
            draw_sprite(screen, fire, bx3, by3);
            by3 = -300;
            score += 25;
            int sound = play_sample(music, 300, 128, 1000, 0);
            pass = 1;
          }
          if (mx + 40 >= bx4 && my >= by4 - 40 && my <= by4 + 40) {
            draw_sprite(screen, fire, bx4, by4);
            by4 = -300;
            score += 50;
            int sound = play_sample(music, 300, 128, 1000, 0);
            pass = 1;
        ...
        void smartmotion() {
          ...
          if (my >= by1 - 30 && my <= by1 - 20) {
            by1 += rand() % (120 - 100) + 100;

          }
          if (my >= by1 - 50 && my <= by1 - 30) {
            by1 -= rand() % (120 - 100) + 100;

          }
          if (my >= by4 - 30 && my <= by4 - 20) {
            by4 += rand() % (120 - 100) + 100;

          }
          if (my >= by4 - 50 && my <= by4 - 30) {
            by4 -= rand() % (120 - 100) + 100;
